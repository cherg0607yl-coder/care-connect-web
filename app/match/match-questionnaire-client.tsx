  ...
  return (
    <main className="mx-auto w-full max-w-2xl px-4 py-10">
      ...
      <p className="mt-2 text-sm leading-relaxed text-zinc-600">
        A short questionnaire helps rank hospices using{" "}
        <strong>your location and preferences</strong> plus{" "}
        <strong>public Medicare data</strong>. This is not medical advice and does not
        pick the “best” hospice for everyone.
      </p>
      ...
      <form onSubmit={(e) => void onSubmit(e)} className="mt-8 space-y-6">
        ...
        <fieldset className="space-y-2 rounded-lg border border-zinc-200 p-4">
          <legend className="px-1 text-sm font-semibold text-zinc-900">
            2. Who are you searching for? (optional for ranking)
          </legend>
          <select
            value={relationship}
        ...
        <fieldset className="space-y-2 rounded-lg border border-zinc-200 p-4">
          <legend className="px-1 text-sm font-semibold text-zinc-900">
            3. Primary condition (as you understand it today)
          </legend>
          <select
            value={condition}
        ...
        <fieldset className="space-y-2 rounded-lg border border-zinc-200 p-4">
          <legend className="px-1 text-sm font-semibold text-zinc-900">
            ...
            (e.g. continuous home care or inpatient hospice)?
          </legend>
          <select
