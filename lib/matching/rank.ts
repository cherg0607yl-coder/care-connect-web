...
const DISCLAIMER =
  "These matches rank public data and your preferences — not medical quality or outcomes. Use the list as a starting point and talk with providers and your care team."
...
export function rankHospiceMatches(
  ...
  return { matches: ranked, disclaimer: DISCLAIMER }
}
